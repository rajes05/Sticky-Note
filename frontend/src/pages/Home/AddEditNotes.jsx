    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-2">
                ...
                <label htmlFor="" className="input-label text-gray-600 font-medium tracking-wider text-sm sm:text-base">
                    Title
                </label>
                ...
                <motion.input
                    id="title-input"
                    type="text"
                    className="text-xl sm:text-2xl text-slate-800 outline-none border-b-2 focus:border-green-300 transition-colors w-full"
                    placeholder="Study data structure"
                    value={title}
            ...
            <motion.button
                className={`btn-primary font-medium mt-4 sm:mt-5 p-2 sm:p-3 bg-linear-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 rounded-lg shadow-md w-full cursor-pointer ${isSubmitting ? "opacity-80" : ""}`}

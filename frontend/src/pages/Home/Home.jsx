...
export default function Home() {
    ...
    const cardVariants = {
        ...
        visible: {
            y: 0,
            opacity: 1,
            transition: { type: "spring", stifness: 100, damping: 12 },
        }
    }
    ...
    return (
        <div className="min-h-screen bg-white relative overflow-hidden">
            ...
            {/* Animation  */}
            <div
                className="absolute inset-0 bg-linear-to-br from-green-50 via-white to-emerald-50 animate-pulse"
            ...
            <div className="relative z-10">
                ...
                <div className="w-full px-3 sm:px-6 lg:px-8 py-4 sm:py-10 max-w-7xl mx-auto">
                    <div className="mb-4 sm:mb-10">
                        ...
                        >
                            <MdOutlineNotes
                                className="text-2xl sm:text-4xl text-green-600 mr-2 sm:mr-3"
                            />
                        ...
                        <div className="h-1 w-10 sm:w-24 bg-linear-to-r from-green-600 via-emerald-500 to-green-500 rounded-full mt-2 shadow-lg shadow-green-500/30"
                        />
                    ...
                    {isLoading ?(
                        <div className="flex justify-center items-center h-48 sm:h-64">
                            <div className="relative">
                                <div className="animate-spin w-12 h-12 sm:w-16 sm:h-16 rounded-full border-4 border-gray-200 border-t-green-600 " />
                            ...
                            <motion.div
                                ...
                                animate={{opacity: 1, y: 0}}
                                transition={{duration:0.5}}
                                className="bg-linear-to-br from-green-50 via-white to-emerald-50 backdrop-blur-xl p-4 sm:p-8 rounded-2xl shadow-2xl border border-green-200 hover:border-green-300 transition-all duration-300"
                            >
                                <EmptyCard
                                    message={
                                        isSearch
                ...
                <Modal
                    ...
                    contentLabel=""
                    className="w-[95%] sm:w-3/4 lg:w-2/5 max-h-[90vh] sm:max-h-[85vh] overflow-y-auto bg-linear-to-br from-white via-green-50 to-white rounded-2xl mx-auto mt-4 sm:mt-10 p-3 sm:p-6 shadow-2xl border border-green-200 outline-none"
                >
                    <AddEditNotes
